        ...
        <div className="container">
          <div className="diokan-entry-page__inner">
            <div className="diokan-entry-page__inner-left">
              <form className="diokan-form diokan-form-sign-up">
                ...
                <div className="diokan-form-group-box">
                  <div className="diokan-form-group">
                    <input className="diokan-form-control" placeholder="Full Name"/>
                  </div>
                  <div className="diokan-form-group">
                ...
                <button className="diokan-btn diokan-btn-form-action">Sign Up</button>
                ...
                <div className="diokan-form__helper">
                  By creating an account, you accept our <a href="" className="diokan-link diokan-link__small">Terms and
                  Conditions.</a>
                </div>
              </form>
            </div>
                ...
                <div className="diokan-info-list__item">
                  <div className="diokan-info-list__item-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="62" height="57" viewBox="0 0 101 93">
                      <g fill="#12A3E1" fill-rule="evenodd">
                        <path
